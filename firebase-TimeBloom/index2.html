...
<body>
    ...
    <main>
        ...
        <section class="flowerbox">
            ...
            <a href="./index3.html"><i class='bx bxs-right-arrow' ></i></a>
        </section>
    ...
    if (isTimerRunning) {
        ...
        flowerImg.src = "./public/f1.gif"; //fade 1
...
function updateTimer() {
    ...
    if (remainingTime <= 0) {
        ...
        if (remainingTime === 1380) {
            flowerImg.classList.add('changed');
            flowerImg.src = "./public/f2.gif";//fade2
        }
        else if (remainingTime === 5) {
            flowerImg.classList.add('changed');
            flowerImg.src = "./public/f3.gif";//fade 3
        }
